// Note: This file is dedicated for cmake project, AC project will use 
// the one under the build directory. 
// 
// It was generated by AC system, but since we cannot do this in cmake, 
