...
set(riscv_gen_insn_list_h ${CMAKE_CURRENT_BINARY_DIR}/insn_list.h)
...
add_custom_command(
        OUTPUT ${riscv_gen_insn_list_h}
        COMMAND ${SCRIPT_DIR}/code_gen.sh
        ARGS insn_list ${riscv_gen_insn_list_h} ${riscv_insn_list}
...
message("Fully supported instruction list: ${space_sep_insn_list}")
